...
See how well the code scales when using channels chained into loops.

Setup
-----

- 10 loops with 100 channels each
...
.. tabs::
   ...
   .. tab:: macOS
      ...
      .. csv-table:: Collected data for weak scaling
         :file: macos/03/benchmark-weak.csv
         :header-rows: 1
      ...
      .. csv-table:: Collected data for strong scaling
         :file: macos/03/benchmark-strong.csv
         :header-rows: 1
